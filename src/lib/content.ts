...
export const SOURCES = [
  ...
  { claim: 'Trip.com Bangkok feature (Issabele23, Aug 2025): pad kra pao, tom yum goong, riverboats passing by',
    publication: 'Trip.com Bangkok · Hansa River House',
    url: 'https://www.trip.com/moments/detail/bangkok-191-135104426/' },
  { claim: 'Trip.com Riverside Retreat feature (Chia Nicholas / Nick @nickeatsg, Nov 2025): seven verified Hansa photographs',
